<?php
// source: C:\wamp64\www\nette-calculator\app/config/config.neon 
// source: C:\wamp64\www\nette-calculator\app/config/config.local.neon 

class Container_5358471835 extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
			...
			'App\Model\CalculatorManager' => [1 => ['1']],
			...
			'App\Presenters\CalculatorPresenter' => [1 => ['application.1']],
		...
		'services' => [
			'application.1' => 'App\Presenters\CalculatorPresenter',
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			...
			'consoleMode' => false,
			'tempDir' => 'C:\wamp64\www\nette-calculator\app/../temp',
		];
	}


	public function createServiceApplication__1(): App\Presenters\CalculatorPresenter
	{
		$service = new App\Presenters\CalculatorPresenter($this->getService('1'));
	...
	public function createServiceApplication__presenterFactory(): Nette\Application\IPresenterFactory
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback(
			$this,
			5,
			'C:\wamp64\www\nette-calculator\app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'
		));
	...
	{
		$service = new Nette\Caching\Storages\SQLiteJournal('C:\wamp64\www\nette-calculator\app/../temp/cache/journal.s3db');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('C:\wamp64\www\nette-calculator\app/../temp/cache', $this->getService('cache.journal'));
		return $service;
	}
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\ILatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\ILatteFactory {
			...
			public function __construct(Container_5358471835 $container)
			{
			...
			public function create(): Latte\Engine
			{
				...
				$service->setTempDirectory('C:\wamp64\www\nette-calculator\app/../temp/cache/latte');
	...
	public function createService1(): App\Model\CalculatorManager
	{
