<?php
// source: C:\wamp64\www\nette-calculator\app\presenters/templates/Calculator/default.latte

use Latte\Runtime as LR;

class Templatea1cc08c4fe extends Latte\Runtime\Template
{
	public $blocks = [
...
<?php
		if (isset($result)) {
			?>	<h3>Result is: <?php echo LR\Filters::escapeHtmlText($result) /* line 9 */ ?></h3>
<?php
		}
		/* line 10 */ $_tmp = $this->global->uiControl->getComponent("calculatorForm");
